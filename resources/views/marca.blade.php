...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregar">Agregar Marca</button>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            @foreach ($clasif as $marca)
            <tr>
                <td>{{$marca->Id_Clasificador}}</td>
                <td>{{$marca->Cf_Descripcion}}</td>
                <td>{{$marca->Cf_Cve_Clasificador}}</td>

                <td>
                    @if ($marca->Id_Estatus == "ACT")
                        
                        <span class="badge bg-green"> {{$marca->Id_Estatus}} </span> &nbsp;
                    @else
                        <span class="badge bg-red"> {{$marca->Id_Estatus}} </span> &nbsp;
                    @endif
                    
                </td>

                @if ($marca->Id_Estatus == "BAJ")
                <td>
                    <form action="{{route('recoverMarca', $marca)}}"method="POST"> @csrf @method('put')
                    <input type="hidden" name="restore_id" id="restore_id" class="form-control" value="{{$marca->Id_Clasificador}}" min="1" maxlength="20" required>
                    <button style='font-size:13px;' type='button' class='btn btn-success' data-toggle="modal" data-target="#modalShow{{$marca->Id_Clasificador}}"><i class='fa fa-eye'></i></button>&nbsp;
                    <button style='font-size:13px;' type='button' class='btn btn-warning' data-toggle="modal" data-target="#modalEditmarca{{$marca->Id_Clasificador}}"><i class='fa fa-edit'></i></button>&nbsp;
                ...
                <td>
                    <button style='font-size:13px;' type='button' class='btn btn-success' data-toggle="modal" data-target="#modalShow{{$marca->Id_Clasificador}}"><i class='fa fa-eye'></i></button>&nbsp;
                    <button style='font-size:13px;' type='button' class='btn btn-warning' data-toggle="modal" data-target="#modalEditmarca{{$marca->Id_Clasificador}}"><i class='fa fa-edit'></i></button>&nbsp;
                    <button style='font-size:13px;' type='button' class='btn btn-danger' data-toggle="modal" data-target="#modalBajamarca{{$marca->Id_Clasificador}}"><i class='fa fa-trash'></i></button>
                </td>   
                @endif
              </tr>
                 
            <!-- Modal Show -->
            <div id="modalShow{{$marca->Id_Clasificador}}" class="modal fade">
            ...
            <!-- Modal Edición Marca-->
            <div id="modalEditmarca{{$marca->Id_Clasificador}}" class="modal fade">
                <form action="{{route('editMarca', $marca)}}" method="POST"> @csrf @method('put')
                <input type="hidden" name="edt_id" id="edt_id" class="form-control" value="{{$marca->Id_Clasificador}}" min="1" maxlength="20" required>
                <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="edt_cfdescripcion" id="txt_cfdescripcion" value="{{$marca->Cf_Descripcion}}"class="form-control" placeholder="Descripcion" min="1" maxlength="20" required>
                                </div>
                                <!-- /.form-group -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="edt_cfclave" id="txt_cfclave" value="{{$marca->Cf_Cve_Clasificador}}" class="form-control" placeholder="Clave de Producto" min="1" maxlength="4">
                                </div>
                            </div>
            ...
            <!-- Modal Baja Marca-->
            <div id="modalBajamarca{{$marca->Id_Clasificador}}" class="modal fade">
                <form action="{{route('bajaMarca', $marca)}}" method="POST"> @csrf @method('put')
                <input type="hidden" name="del_id" id="del_id" class="form-control" value="{{$marca->Id_Clasificador}}" min="1" maxlength="20" required>

                <input type="hidden" name="txt_cfuserbaja" id="txt_cfuserbaja" class="form-control" value="Rogelio" min="1" maxlength="20" required>
                <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title"> Estatus Marca </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title"> ¿Realmente desea dar de baja la Marca? </h3>
                        ...
                        <div class="card-body">
                            ...
                            <!--Tipo -->
                            <input type="hidden" name="txt_cftipo" id="txt_cftipo" class="form-control" value="MA" min="1" maxlength="20" required>
    ...
    <form action="{{route('createMarca')}}" method="POST"> @csrf
